...
```
  123|     my Str $source = $input-file.IO.slurp;
...
```
  124|     my Str $cleaned-source = $source;
  125|     $cleaned-source ~~ s:g{    \=end (\N*) \n+}      =  "\=end$0\n";
  126|     $cleaned-source ~~ s:g{\n+ \=begin (<hws> pod) } = "\n\=begin$0";
...
----
Rendered from  at 2023-09-17T01:45:55Z
