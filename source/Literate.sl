...
# Last modified: Wed 06 Sep 2023 04:48:51 PM EDT
# Version 0.0.1
...
=begin pod 1
The remainder of the C<begin-pod> directive can only be whitespace.
=end pod
...
=end pod
    ...
    #TODO figure out how to delete comments while leaving no-weave directives
#=begin pod 1
#
