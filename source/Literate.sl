...
L<no-weave|#no-weave> for why some code would not be included in the woven
code.
...
Simply append C<#no-weave> at the end of the line!
...
Simply add comments C<#no-weave> and C<#end-no-weave> before and after the
